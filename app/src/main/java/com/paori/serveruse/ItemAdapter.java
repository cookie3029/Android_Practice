...
public class ItemAdapter extends BaseAdapter {
    ...
    // 아래 2개 메서드는 getCount에서 리턴한 개수만큼 반복
    @Override
    ...
    // 실제 셀의 모양을 결정하는 메서드
    // i는 각 셀의 인덱스
    // View는 화면에 보여지는 뷰로 처음에는 null이 넘어오고 두번째부터는 이전에 출력한 View가 넘어옵니다.
        ...
        class ThreadEx extends  Thread {
            public void run () {
                ...
                try {
                    ...
                    InputStream inputStream = new URL("http://192.168.55.139/member/download?path=" + item.getPictureurl()).openStream();
